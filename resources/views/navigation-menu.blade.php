 <nav class="bg-gray-800" x-data="{ open: false }">
      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <a href="/" class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-8 w-auto rounded-full" src="{{asset('img/logo.png')}}" alt="Workflow">
            <img class="hidden lg:block h-8 w-auto rounded-full" src="{{asset('img/logo.png')}}" alt="Workflow">
          </a>
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('conocenos') }}" :active="request()->routeIs('conocenos')">
                        {{ __('Conocenos') }}
                    </x-jet-nav-link>
                    </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('conocenos') }}" :active="request()->routeIs('conocenos')">
                {{ __('Conocenos') }}
            </x-jet-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
